...
const en: SiteContent = {
    ...
    groups: [
      {
        ...
        items: [
          { name: 'Cylindrical Sheet Steel Drum Ring', tag: 'Sheet Steel Drum Ring', desc: 'For cylindrical drum bodies; used with UN-labelled/unlabelled drums in the chemical, petrochemical, mineral oil and food industries.', img: '/img/silindirik-sac-varil-cemberi.webp' },
          { name: 'Conical Sheet Steel Drum Ring', tag: 'Sheet Steel Drum Ring', desc: 'For conically shaped drums; used with UN-labelled/unlabelled drums in the chemical, petrochemical, mineral oil and food industries.', img: '/img/konik-sac-varil-cemberi.webp' },
          { name: 'Sheet Metal Pail Ring', tag: 'Sheet Steel Drum Ring', desc: 'For pail bodies; used with UN-labelled/unlabelled containers in the chemical, petrochemical, mineral oil and food industries.', img: '/img/sac-bidon-cemberi.webp' },
          { name: 'Plastic Drum Ring', tag: 'Rings', desc: 'For 30-60-120-150-175 L plastic drums; used with UN-labelled containers in the chemical, cosmetics and food industries.', img: '/img/plastik-varil-cemberi.webp' },
          { name: 'Plastic Pail Ring', tag: 'Rings', desc: 'For plastic pails; used with UN-labelled containers in the chemical, cosmetics and food industries.', img: '/img/plastik-kova-cemberi.webp' },
          { name: 'Fibre Drum Ring', tag: 'Rings', desc: 'In Ø280-360-400-500-600-650 sizes; used with UN and non-UN fibre drums in the chemical, pharmaceutical and food industries.', img: '/img/fiber-varil-cemberi.webp' },
          { name: 'UN-Certified Pail Ring', tag: 'Tin Pail Ring', desc: 'A UN-certified tin pail ring for packaging hazardous materials in the paint, chemical, petrochemical and mineral oil industries.', img: '/img/unli-kova-cemberi.webp' },
          { name: 'Non-UN Pail Ring', tag: 'Tin Pail Ring', desc: 'A tin pail ring for packaging non-hazardous materials in the paint, chemical, petrochemical and mineral oil industries.', img: '/img/unsiz-kova-cemberi.webp' },
          { name: 'Bolted Rings', tag: 'Special Purpose', desc: 'A custom-made ring for drums used in the disposal of highly hazardous materials and contaminated waste.', img: '/img/civatali-cember.webp' },
          { name: 'Stainless Steel Ring', tag: 'Special Purpose', desc: 'A custom-made stainless-steel ring for high liquid contact, especially suited to the food and fishing industries.', img: '/img/paslanmaz-cember.webp' },
          { name: 'Painted Rings', tag: 'Special Purpose', desc: 'A custom-made ring produced in the colour and coating requested by the customer.', img: '/img/boyali-cemberler.webp' },
        ],
      },
      {
        id: 'kulplar',
        ...
        items: [
          { name: 'Metal Drum Handles', tag: 'Handles', desc: 'Mounted on the drum body or lid; available painted, galvanised or in raw metal finish.', img: '/img/metal-kulplar.webp' },
          { name: 'Fibre Drum Handles', tag: 'Handles', desc: 'Galvanised metal handles mounted on the fibre drum body, in various sizes.', img: '/img/fiber-kulplar.webp' },
        ],
      },
      {
        id: 'aksesuarlar',
        ...
        items: [
          { name: 'Metal Tamper-Evident Caps', tag: 'Accessory', desc: 'In 2" and 3/4" sizes; available branded or unbranded, gasketed or ungasketed, and lacquered.', img: '/img/metal-garanti-kapaklari.webp' },
          { name: 'Clamps', tag: 'Accessory', desc: 'The locking mechanism that opens and closes the ring; can also be supplied separately on request.', img: '/img/kelepceler.webp' },
          { name: 'Plastic Plugs', tag: 'Accessory', desc: 'L-ring plugs and tamper-evident caps; guarantee leak-tightness on 220 L threaded-plug plastic drums.', img: '/img/plastik-tapalar.webp' },
          { name: 'Safety Pins', tag: 'Accessory', desc: 'Plastic and metal pins that prevent the clamp from opening accidentally and show the product is unused.', img: '/img/emniyet-pimleri.webp' },
        ],
      },
    ],
    ...
    blocks: [
      {
        ...
        title: 'Consultancy',
        icon: 'consult',
        summary: 'Professional consultancy through technical assessment, R&D work, sample production and trial testing tailored to the customer.',
        bullets: ['Technical needs analysis', 'Sample production', 'Sector consultancy', 'Trial testing'],
        paras: [
      ...
      },
      {
        ...
        icon: 'design',
        summary: 'An expert engineering team delivering new designs and technical updates in step with developments in the sector.',
        bullets: ['New product design', 'Technical spec updates', 'Sector trend analysis', 'Custom project design'],
        paras: [
      ...
      },
      {
        ...
        icon: 'develop',
        summary: 'R&D work driven by customer feedback, optimising quality and cost under a philosophy of continuous improvement.',
        bullets: ['Continuous improvement', 'Customer feedback analysis', 'Cost optimisation', 'Quality improvement work'],
        paras: [
      ...
      },
      {
        ...
        icon: 'test',
        summary: 'Raw material, semi-finished and finished-product testing to standard, backed by technical documentation and logistics support.',
        bullets: ['Raw material testing', 'Semi-finished verification', 'Finished product testing', 'Technical documentation support'],
        paras: [
  ...
  quality: {
    ...
    certsBlock: {
      ...
      items: [
        { code: 'ISO 9001', name: 'Quality Management System', icon: 'award', desc: 'The international quality management standard for consistent, continuously improving products and services.', img: '/img/iso9001.webp' },
        { code: 'ISO 10002', name: 'Customer Satisfaction MS', icon: 'users', desc: 'A management system ensuring customer complaints and requests are handled transparently and fairly.', img: '/img/iso10002.webp' },
        { code: 'ISO 45001', name: 'Occupational Health & Safety MS', icon: 'shield', desc: 'The international standard certifying proactive management of employee health and safety risks.', img: '/img/iso45001.webp' },
        { code: 'CE', name: 'Collapsible Cage', icon: 'check', desc: 'A product marking certifying conformity with European Union technical regulations.', img: '/img/ce-geri-donusum.webp' },
        { code: 'CE', name: 'Rigid Cage', icon: 'check', desc: 'A product marking certifying conformity with European Union technical regulations.', img: '/img/ce-rijit.webp' },
        { code: 'CE', name: 'Foldable Cage', icon: 'check', desc: 'A product marking certifying conformity with European Union technical regulations.', img: '/img/ce-katlanabilir.webp' },
        { code: 'ISO 14001', name: 'Environmental Management System', icon: 'growth', desc: 'A standard certifying that environmental impacts across production are managed systematically.', img: '/img/iso14001.webp' },
        { code: 'I-REC', name: 'Green Energy (Headquarters)', icon: 'spark', desc: 'An internationally recognised certificate confirming energy use is sourced from renewables.', img: '/img/irec-merkez.webp' },
        { code: 'I-REC', name: 'Green Energy (Branch)', icon: 'spark', desc: 'An internationally recognised certificate confirming energy use is sourced from renewables.', img: '/img/irec-sube.webp' },
      ],
      statsBand: {
        kicker: 'Integrated Management System',
        title: 'Quality, Environment, Safety and Satisfaction',
        text: 'All of our certifications operate under one integrated management system, letting us manage quality, environmental impact, workplace safety and customer satisfaction to the same standard across production.',
        stats: [
          { n: '9', l: 'Certificates' },
          { n: 'ISO', l: 'International' },
          { n: 'CE', l: 'EU Conformity' },
        ],
      },
    },
    membership: {
