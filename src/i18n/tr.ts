    ...
    groups: [
      {
        ...
        items: [
          { name: 'Silindirik Sac Varil Çemberi', tag: 'Sac Varil Çemberi', img: '/img/silindirik-sac-varil-cemberi.webp' },
          { name: 'Konik Sac Varil Çemberi', tag: 'Sac Varil Çemberi', img: '/img/konik-sac-varil-cemberi.webp' },
          { name: 'Sac Bidon Çemberi', tag: 'Sac Varil Çemberi', img: '/img/sac-bidon-cemberi.webp' },
          { name: 'Plastik Varil Çemberi', tag: 'Çemberler', img: '/img/plastik-varil-cemberi.webp' },
          { name: 'Fiber Varil Çemberi', tag: 'Çemberler', img: '/img/fiber-varil-cemberi.webp' },
          { name: "UN'li Kova Çemberi", tag: 'Teneke Kova Çemberi', img: '/img/unli-kova-cemberi.webp' },
          { name: "UN'siz Kova Çemberi", tag: 'Teneke Kova Çemberi', img: '/img/unsiz-kova-cemberi.webp' },
          { name: 'Cıvatalı Çemberler', tag: 'Özel Amaçlı', img: '/img/civatali-cember.webp' },
          { name: 'Paslanmaz Çember', tag: 'Özel Amaçlı', img: '/img/paslanmaz-cember.webp' },
          { name: 'Boyalı Çemberler', tag: 'Özel Amaçlı', img: '/img/boyali-cemberler.webp' },
        ],
      },
      {
        id: 'kulplar',
        ...
        items: [
          { name: 'Metal Varil Kulpları', tag: 'Kulplar', img: '/img/metal-kulplar.webp' },
          { name: 'Fiber Varil Kulpları', tag: 'Kulplar', img: '/img/fiber-kulplar.webp' },
        ],
      },
      {
        id: 'aksesuarlar',
        ...
        items: [
          { name: 'Metal Garanti Kapakları', tag: 'Aksesuar', img: '/img/metal-garanti-kapaklari.webp' },
          { name: 'Kelepçeler', tag: 'Aksesuar', img: '/img/kelepceler.webp' },
          { name: 'Plastik Tapalar', tag: 'Aksesuar', img: '/img/plastik-tapalar.webp' },
          { name: 'Emniyet Pimleri', tag: 'Aksesuar', img: '/img/emniyet-pimleri.webp' },
        ],
      },
    ],
