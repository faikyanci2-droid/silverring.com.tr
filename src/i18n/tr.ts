...
const tr = {
    ...
    blocks: [
      {
        ...
        title: 'Danışmanlık',
        icon: 'consult',
        summary: 'Müşteri ihtiyaçlarına uygun teknik değerlendirme, AR-GE çalışmaları, numune üretimi ve deneme testleri ile profesyonel danışmanlık hizmeti.',
        bullets: ['Teknik ihtiyaç analizi', 'Numune üretimi', 'Sektörel danışmanlık', 'Deneme testleri'],
        paras: [
      ...
      },
      {
        ...
        title: 'Ürün Tasarımı',
        icon: 'design',
        summary: 'Sektörel gelişmelere paralel yeni tasarım ve teknik özellik güncellemeleri yapan uzman mühendislik ekibi.',
        bullets: ['Yeni ürün tasarımı', 'Teknik özellik güncellemeleri', 'Sektörel trend analizi', 'Özel proje tasarımı'],
        paras: [
      ...
      },
      {
        ...
        icon: 'develop',
        summary: 'Sürekli iyileştirme felsefesiyle, müşteri geri bildirimlerine dayalı kalite ve maliyet optimize edici AR-GE çalışmaları.',
        bullets: ['Sürekli iyileştirme', 'Müşteri geri bildirim analizi', 'Maliyet optimizasyonu', 'Kalite artırma çalışmaları'],
        paras: [
      ...
      },
      {
        ...
        icon: 'test',
        summary: 'Standartlara uygun hammadde, yarı mamul ve bitmiş ürün testleri, teknik doküman ve lojistik desteği.',
        bullets: ['Hammadde testleri', 'Yarı mamul doğrulama', 'Bitmiş ürün testleri', 'Teknik doküman desteği'],
        paras: [
  ...
  quality: {
    ...
    certsBlock: {
      ...
      items: [
        { code: 'ISO 9001', name: 'Kalite Yönetim Sistemi', icon: 'award', desc: 'Ürün ve hizmet kalitesinde sürekli iyileştirmeyi standartlaştıran uluslararası kalite yönetim sistemi.', img: '/img/iso9001.webp' },
        { code: 'ISO 10002', name: 'Müşteri Memnuniyeti YS', icon: 'users', desc: 'Müşteri şikayet ve taleplerinin şeffaf ve adil şekilde ele alınmasını sağlayan yönetim sistemi.', img: '/img/iso10002.webp' },
        { code: 'ISO 45001', name: 'İş Sağlığı ve Güvenliği YS', icon: 'shield', desc: 'Çalışan sağlığı ve güvenliği risklerinin proaktif olarak yönetildiğini belgeleyen uluslararası standart.', img: '/img/iso45001.webp' },
        { code: 'CE', name: 'Geri Dönüşür Kafes', icon: 'check', desc: 'Avrupa Birliği teknik düzenlemelerine uygunluğu belgeleyen ürün işareti.', img: '/img/ce-geri-donusum.webp' },
        { code: 'CE', name: 'Rijit Kafes', icon: 'check', desc: 'Avrupa Birliği teknik düzenlemelerine uygunluğu belgeleyen ürün işareti.', img: '/img/ce-rijit.webp' },
        { code: 'CE', name: 'Katlanabilir Kafes', icon: 'check', desc: 'Avrupa Birliği teknik düzenlemelerine uygunluğu belgeleyen ürün işareti.', img: '/img/ce-katlanabilir.webp' },
        { code: 'ISO 14001', name: 'Çevre Yönetim Sistemi', icon: 'growth', desc: 'Üretim süreçlerindeki çevresel etkilerin sistematik şekilde yönetildiğini gösteren çevre yönetim standardı.', img: '/img/iso14001.webp' },
        { code: 'I-REC', name: 'Yeşil Enerji (Merkez)', icon: 'spark', desc: 'Kullanılan enerjinin yenilenebilir kaynaklardan sağlandığını uluslararası düzeyde belgeleyen sertifika.', img: '/img/irec-merkez.webp' },
        { code: 'I-REC', name: 'Yeşil Enerji (Şube)', icon: 'spark', desc: 'Kullanılan enerjinin yenilenebilir kaynaklardan sağlandığını uluslararası düzeyde belgeleyen sertifika.', img: '/img/irec-sube.webp' },
      ],
      statsBand: {
        kicker: 'Entegre Yönetim Sistemi',
        title: 'Kalite, Çevre, Güvenlik ve Memnuniyet',
        text: 'Tüm sertifikalarımız entegre bir yönetim sistemi çerçevesinde uygulanmaktadır. Bu sayede, üretim süreçlerimizde kaliteyi, çevreyi, iş güvenliğini ve müşteri memnuniyetini aynı standartta yönetiyoruz.',
        stats: [
          { n: '9', l: 'Sertifika' },
          { n: 'ISO', l: 'Uluslararası' },
          { n: 'CE', l: 'AB Uyum' },
        ],
      },
    },
